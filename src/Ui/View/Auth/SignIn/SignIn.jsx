                ...
                <div className="bg-white px-10 py-20 rounded-3xl border-2 border-gray-200">
                    ...
                    <div className="mt-8">
                        ...
                        <div className="mt-8 flex justify-between items-center">
                            ...
                            <button className="font-medium text-base text-violet-500">Forgot your password?</button>
                        </div>
                        <div className="mt-8 flex flex-col gap-y-4">
                            <button
                                className="active:scale-[.98] active:duration-75 transition-all hover:scale-[1.01] ease-in-out py-3 rounded-2xl bg-violet-500 text-white text-lg font-bold">Sign
                                in
                            </button>
                            <button
