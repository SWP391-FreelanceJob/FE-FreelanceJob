            ...
            >
              <div className="px-5">
                <div className="flex justify-between items-center">
                  <div className="flex">
                    ...
                    <div className="overflow-hidden">
                      <h1 className="mb-1 text-xl font-semibold">{job.name}</h1>
                ...
                <div className="mt-5 mb-3 flex justify-between bg-slate-100">
                  <div className="flex">
                    <div className="pl-2 py-2">Hà Tây</div>
                    <div className="divider divider-horizontal mx-2 my-2" />
                    <div className="py-2">Bán kem</div>
                  </div>
                  <div className="flex items-center mr-3">
                    ...
                    /> */}
                    <div className="divider divider-horizontal mx-2 my-2" />
                    <p className="">Đã làm: {job.jobDone} dự án</p>
                  </div>
                </div>
                <div className="flex justify-between items-center">
